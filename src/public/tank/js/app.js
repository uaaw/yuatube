...
/***/function (module, exports, __webpack_require__) {
  ...
  */
	...
	var DrawingUtil = __webpack_require__(3);
	var socketIoClient = __webpack_require__(6);
	var socket;
...
/***/function (module, exports) {
	...
	module.exports = {
		...
		'83': 'KEY_DOWN',
		'drawing': {
			'drawingOrder': ["perspective", "tanks", "bullets", "walls", "ammo", "playerInfo", "scoreboard", "radar"],
			'ammo': {
				'tankXOffset': 45,
				'tankYOffset': 40,
				'width': 5,
...
/***/function (module, exports, __webpack_require__) {
  ...
  */
	...
	var Canvas = function () {
		function Canvas() {
			var canvasId = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'game_canvas';
		...
		var self = this;
			...
			// Virtual joystick for smooth touch controls
			...
			function updateJoystick(touch) {
				...
				// Map joystick position to smooth directional input
				var strength = Math.min(dist / maxDist, 1);
				self.userInput.keysPressed.KEY_UP = dy < -5;
				self.userInput.keysPressed.KEY_DOWN = dy > 5;
				self.userInput.keysPressed.KEY_LEFT = dx < -5;
				self.userInput.keysPressed.KEY_RIGHT = dx > 5;
				// Update aim angle to match movement direction
				if (dist > 5) {
					self.userInput.mouseAngle = Math.atan2(-dy, dx);
				}
			}
			...
			this.canvas.addEventListener('touchstart', function(e) {
				...
				for (var i = 0; i < e.changedTouches.length; i++) {
					...
					// Left half of screen = joystick, right half = aim/fire
					if (touch.clientX < window.innerWidth / 2) {
						...
						// Right side = fire
						self.userInput.mouseClicked = true;
						var rect = this.getBoundingClientRect();
						var x = rect.width / 2 - (touch.clientX - rect.left);
						var y = rect.height / 2 - (touch.clientY - rect.top);
						self.userInput.mouseAngle = Math.atan2(y, x);
					}
				}
			}, { passive: false });
			...
			this.canvas.addEventListener('touchend', function(e) {
				...
				for (var i = 0; i < e.changedTouches.length; i++) {
					...
					if (touch.identifier === joystickId) {
						...
						self.userInput.keysPressed.KEY_UP = false;
						self.userInput.keysPressed.KEY_DOWN = false;
						self.userInput.keysPressed.KEY_LEFT = false;
						self.userInput.keysPressed.KEY_RIGHT = false;
					} else if (touch.clientX > window.innerWidth / 2) {
						self.userInput.mouseClicked = false;
					}
				}
			}, { passive: false });

			// Show fire button on mobile/touch devices
			var fireBtn = document.getElementById('fireBtn');
			if ('ontouchstart' in window && fireBtn) {
  ...
  */
	...
	var DrawingUtil = function () {
		function DrawingUtil(canvas) {
			var perspective = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { x: global.gameWidth / 2, y: global.gameHeight / 2 };
			var drawingOrder = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : global.drawing.drawingOrder;

			_classCallCheck(this, DrawingUtil);
    ...
    */
			...
			this.tankHullImage.src = "/tank/img/sprite-tank-hull-256.png";

			this.tankGunImage = new Image();
			this.tankGunImage.src = "/tank/img/sprite-tank-gun-256.png";
		}
   ...
   */
		...
		_createClass(DrawingUtil, [{
			key: 'perspectiveDraw',
			value: function perspectiveDraw(perspective) {
    ...
    */
			...
			key: 'tanksDraw',
			value: function tanksDraw(tanks) {
				...
				try {
					for (var _iterator = tanks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
						var tank = _step.value;
						...
						var startX = tank.x + global.drawing.playerInfo.tankXOffset;
						var startY = tank.y + global.drawing.playerInfo.tankYOffset;
						...
						// Update boost bar
						var newBoostPercent = tank._boostRemaining / 100 * 100;
    ...
    */
			...
			key: 'bulletsDraw',
			value: function bulletsDraw(bullets) {
				var translateX = -(this.perspective.x - global.screenWidth / 2);
				var translateY = -(this.perspective.y - global.screenHeight / 2);
				this.context2D.translate(translateX, translateY);
    ...
    */
			...
			key: 'tracksDraw',
			value: function tracksDraw(tracks) {
				var translateX = -(this.perspective.x - global.screenWidth / 2);
				var translateY = -(this.perspective.y - global.screenHeight / 2);
				this.context2D.translate(translateX, translateY);
			...
			key: 'wallsDraw',
			value: function wallsDraw(walls) {
				var translateX = -(this.perspective.x - global.screenWidth / 2);
				var translateY = -(this.perspective.y - global.screenHeight / 2);
				this.context2D.translate(translateX, translateY);
				this.context2D.fillStyle = 'black';
			...
			value: function ammoDraw(ammo) {
				if (global.playerType === 'PLAYER') {
					...
					var startX = this.perspective.x + global.drawing.ammo.tankXOffset;
					var startY = this.perspective.y + global.drawing.ammo.tankYOffset;

					for (var i = 0; i < ammo.capacity; i++) {
						if (i < ammo.count) {
    ...
    */
			...
			key: 'scoreboardDraw',
			value: function scoreboardDraw(scoreboardList) {
				var leaderboardRowsDiv = document.getElementById("leaderboard-rows");
				...
				try {
					for (var _iterator4 = scoreboardList[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
    ...
    */
			...
			key: 'radarDraw',
			value: function radarDraw(radarObjects) {
				...
				for (var i = 0; i < walls.length; i++) {
					this.context2D.fillRect(radarX + walls[i].x * horizontalScale, radarY + walls[i].y * verticalScale, walls[i].w * horizontalScale, walls[i].h * verticalScale);
				}
				...
				for (var j = 0; j < tanks.length; j++) {
					...
					this.context2D.fillRect(radarX + tanks[j].x * horizontalScale, radarY + tanks[j].y * verticalScale, global.drawing.radar.tankWidth * horizontalScale, global.drawing.radar.tankHeight * verticalScale);
				}

				//draw radar
				this.context2D.fillStyle = global.drawing.radar.backgroundFill;

				this.context2D.fillRect(radarX, radarY, global.drawing.radar.width, global.drawing.radar.height);
			}
    ...
    */
			...
			key: 'drawGameObjects',
			value: function drawGameObjects(gameObjects) {
				var _iteratorNormalCompletion5 = true;
				var _didIteratorError5 = false;
				var _iteratorError5 = undefined;

				try {
					for (var _iterator5 = this.drawingOrder[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
			...
			key: 'setPerspective',
			value: function setPerspective(x, y) {
				//shorthand ES6
				this.perspective = { x: x, y: y };
			}
		}]);
  ...
  */
	var Sprite = function () {
		function Sprite() {
			...
			var ticksPerFrame = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
			var rowFrameCount = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 1;
			var colFrameCount = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 1;
			var rowFrameIndex = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 0;
			var colFrameIndex = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : 0;
		...
		_createClass(Sprite, [{
			...
			key: 'render',
			value: function render(sprite, context, image, destX, destY) {
...
/***/function (module, exports, __webpack_require__) {
	...
	var uid = __webpack_require__(25);
	var _Symbol2 = __webpack_require__(10).Symbol;
...
/***/function (module, exports, __webpack_require__) {
	...
	$export($export.S + $export.F * !__webpack_require__(12), 'Object', { defineProperties: __webpack_require__(54) });
...
/***/function (module, exports, __webpack_require__) {
	...
	if (!(HAS_INSTANCE in FunctionProto)) __webpack_require__(17).f(FunctionProto, HAS_INSTANCE, { value: function value(O) {
...
/***/function (module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F * (!!$toFixed && (0.00008.toFixed(3) !== '0.000' || 0.9.toFixed(0) !== '1' || 1.255.toFixed(2) !== '1.25' || 1000000000000000128.0.toFixed(0) !== '1000000000000000128') || !__webpack_require__(13)(function () {
		// V8 ~ Android 4.3-
		$toFixed.call({});
	})), 'Number', {
...
/***/function (module, exports, __webpack_require__) {
	...
	__webpack_require__(16)(IteratorPrototype, __webpack_require__(33)('iterator'), function () {
		return this;
	});
...
/***/function (module, exports, __webpack_require__) {
	...
	// @@match logic
	__webpack_require__(212)('match', 1, function (defined, MATCH, $match, maybeCallNative) {
		return [
...
/***/function (module, exports, __webpack_require__) {
	...
	// @@replace logic
	__webpack_require__(212)('replace', 2, function (defined, REPLACE, $replace, maybeCallNative) {
		return [
...
/***/function (module, exports, __webpack_require__) {
	...
	// @@search logic
	__webpack_require__(212)('search', 1, function (defined, SEARCH, $search, maybeCallNative) {
		return [
...
/***/function (module, exports, __webpack_require__) {
	...
	var advanceStringIndex = __webpack_require__(210);
	var toLength = __webpack_require__(44);
	var callRegExpExec = __webpack_require__(211);
	var regexpExec = __webpack_require__(206);
	var fails = __webpack_require__(13);
	var $min = Math.min;
	var $push = [].push;
	...
	// @@split logic
	__webpack_require__(212)('split', 2, function (defined, SPLIT, $split, maybeCallNative) {
		var internalSplit;
...
/***/function (module, exports, __webpack_require__) {
	...
	var validate = __webpack_require__(229);
	var MAP = 'Map';
...
/***/function (module, exports, __webpack_require__) {
	...
	__webpack_require__(230)(WEAK_SET, function (get) {
...
/***/function (module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(14);
	var $typed = __webpack_require__(236);
...
/***/function (module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(14);
	var flattenIntoArray = __webpack_require__(267);
	var toObject = __webpack_require__(52);
	var toLength = __webpack_require__(44);
	var aFunction = __webpack_require__(30);
...
/***/function (module, exports, __webpack_require__) {
	...
	__webpack_require__(12) && $export($export.P + __webpack_require__(283), 'Object', {
...
/***/function (module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(28) || !__webpack_require__(13)(function () {
		var K = Math.random();
...
/***/function (module, exports, __webpack_require__) {
	...
	$export($export.P + $export.R, 'Set', { toJSON: __webpack_require__(288)('Set') });
...
/***/function (module, exports, __webpack_require__) {
	...
	__webpack_require__(297)('WeakMap');
...
/***/function (module, exports, __webpack_require__) {
	...
	__webpack_require__(297)('WeakSet');
